...
async function runSourceChecks() {
  ...
  assert(
    packageJsonSource.includes('"three"')
      ...
      && challengeTestPageSource.includes("export const STANDARD_ARROW_TRAVEL_MS = 500")
      && challengeTestPageSource.includes("function arrowTravelDuration")
      && challengeTestPageSource.includes("flight.durationMs")
      ...
      && challengeTestPageSource.includes("const GAMMA_SHAPE = 3.25")
      && challengeTestPageSource.includes("const GAMMA_SCALE = 0.76")
      ...
      && challengeTestPageSource.includes("inverseBeta22Cdf")
      && challengeTestPageSource.includes("meanScore")
      && challengeTestPageSource.includes("ringColorsOuterToInner")
