...
async function runSourceChecks() {
  ...
  assert(appSource.includes('from "./ui/GameSections"') && gameSectionsSource.includes("function AllocationPanel") && gameSectionsSource.includes("function TurnActionPanel") && !appSource.includes("function AllocationPanel") && !appSource.includes("function TurnActionPanel"), "Game-stage section UI is imported instead of defined inline.");
