...
The app renders the map as one shared SVG coordinate system. This avoids gaps and coordinate drift while still letting the app treat each territory as an interactive component.
